...
female_hairs = [
    ...
    'style 2: bun w/bangB',
    'style 3: Ponytail',
    'style 4: Ponytail w/bangA',
    'style 5: Ponytail w/bangB',
    'style 6: poof+barrette',
    'style 7: poof+barrette w/bang',
    'style 8: half down main+bun+backhair',
    'style 9: half down main+pony+backhair',
    'style 10: half down main+backhair+barrette',
    'style 11: braid back+barrette',
    'style 12: braid back+barrette w/bangA',
    'style 13: braid back+barrette w/bangB',
    'style 14: layered long',
    'style 15: layered short',
    'style 16: dreads short']
shirt_styles = [
    'S_short_sleeve_round_neck',
    'S_short_sleeve_vneck',
    'S_short_sleeve_square_neck',
    'S_long_sleeve_vneck_puffy',
    'S_long_sleeve_vneck_collar',
    'S_long_sleeve_tall_collar']
vector_tattoos = [
    [
        0,
        0.29999999999999999,
...
jewelry_geos_face = [
    'acc_none',
    'acc_face_brow_spike_left',
    'acc_face_brow_spike_right',
    'acc_face_brow_ring_left',
    'acc_face_brow_ring_right',
    'acc_face_ear_cuff_a_left',
    'acc_face_ear_cuff_a_right',
    'acc_face_ear_cuff_b_left',
    'acc_face_ear_cuff_b_right',
    'acc_face_ear_cuff_c_left',
    'acc_face_ear_cuff_c_right',
    'acc_face_ear_open_left',
    'acc_face_ear_open_right',
    'acc_face_ear_stud_left',
    'acc_face_ear_stud_right',
    'acc_face_ear_spike_top_left',
    'acc_face_ear_spike_top_right',
    'acc_face_ear_spike_bot_left',
    'acc_face_ear_spike_bot_right',
    'acc_face_ear_hoop_a_left',
    'acc_face_ear_hoop_a_right',
    'acc_face_ear_hoop_b_left',
    'acc_face_ear_hoop_b_right',
    'acc_face_ear_bighoop_left',
    'acc_face_ear_bighoop_right',
    'acc_face_lip_ring_top_left',
    'acc_face_lip_ring_top_right',
    'acc_face_lip_ring_bot_left',
    'acc_face_lip_ring_bot_right',
    'acc_face_nose_ring_left',
    'acc_face_nose_ring_right',
    'acc_face_lip_ring_center',
    'acc_face_lip_jawry',
    'acc_face_nose_post_top',
    'acc_face_nose_post_bot',
    'acc_face_nose_ring_center',
    'acc_face_lip_mustache']
jewelry_geos_body = [
    'acc_none',
    'acc_body_ring_left_index_base',
    'acc_body_ring_right_index_base',
    'acc_body_ring_left_index_stone',
    'acc_body_ring_right_index_stone',
    'acc_body_ring_left_mid_base',
    'acc_body_ring_right_mid_base',
    'acc_body_ring_left_mid_stone',
    'acc_body_ring_right_mid_stone',
    'acc_body_ring_left_ring_base',
    'acc_body_ring_right_ring_base',
    'acc_body_ring_left_ring_stone',
    'acc_body_ring_right_ring_stone',
    'acc_body_ring_left_pinky_base',
    'acc_body_ring_right_pinky_base',
    'acc_body_ring_left_pinky_stone',
...
class PirateFemale(DirectObject.DirectObject):
        ...
        def setupMultiTexture(parts):
            for i in xrange(0, len(parts)):
                if not parts[i].isEmpty():
                    for j in xrange(0, parts[i].getNumPaths()):
                        hair = parts[i][j]
                        tc = hair.findAllTextureStages()
                        for k in xrange(0, tc.getNumTextureStages()):
                        ...
                        for k in xrange(0, tc.getNumTextureStages()):
                            if tc[k].getTexcoordName().getName().find('Light') != -1:
                                ...
                                tc[k].setSort(10)
                                continue
                            if tc[k].getTexcoordName().getName().find('Dark') != -1:
                                tc[k].setSort(0)
                                continue
    ...
    def showHair(self):
        for i in xrange(0, len(self.hairs[self.hairIdx])):
    ...
    def setupBody(self, lodName = '2000'):
        ...
        layerBList = [
            ...
            '**/body_knee_right',
            '**/body_uppercalf_left',
            '**/body_uppercalf_right',
            '**/body_lowercalf_left',
            '**/body_lowercalf_right',
            '**/body_foot_left',
            '**/body_foot_right',
            '**/body_armpit_left',
            '**/body_armpit_right']
        ...
        self.lowLODSkinColor = VBase4(0.84999999999999998, 0.73999999999999999, 0.68000000000000005, 1.0)
    ...
    def setupClothing(self, lodName = '2000'):
        ...
        if base.config.GetBool('want-gen-pics-buttons'):
            self.clothesByType = {
                ...
                'PANT': self.clothingsLayer1[15:20] + self.clothingsLayer1[26:27],
                'COAT': self.clothingsLayer3,
                'BELT': self.clothingsLayer2[5:],
                'SHOE': self.clothingsLayer1[22:26] + self.clothingsLayer1[27:28],
    ...
    def setupSelectionChoices(self, type, versionFilter = None, rarityFilter = None, isFromLoot = True, isFromShop = True, isFromQuest = True, isFromPromo = True, isFromPVP = True, isFromNPC = True, holidayFilter = None):
        ...
        for hatId in hats:
            ...
            if not isFromLoot or ItemGlobals.isFromLoot(hatId):
                if not isFromShop or ItemGlobals.isFromShop(hatId):
                    if not isFromQuest or ItemGlobals.isFromQuest(hatId):
        ...
        for shirtId in shirts:
            ...
            if not isFromLoot or ItemGlobals.isFromLoot(shirtId):
                if not isFromShop or ItemGlobals.isFromShop(shirtId):
                    if not isFromQuest or ItemGlobals.isFromQuest(shirtId):
        ...
        for vestId in vests:
            ...
            if not isFromLoot or ItemGlobals.isFromLoot(vestId):
                if not isFromShop or ItemGlobals.isFromShop(vestId):
                    if not isFromQuest or ItemGlobals.isFromQuest(vestId):
        ...
        for coatId in coats:
            ...
            if not isFromLoot or ItemGlobals.isFromLoot(coatId):
                if not isFromShop or ItemGlobals.isFromShop(coatId):
                    if not isFromQuest or ItemGlobals.isFromQuest(coatId):
        ...
        for pantId in pants:
            ...
            if not isFromLoot or ItemGlobals.isFromLoot(pantId):
                if not isFromShop or ItemGlobals.isFromShop(pantId):
                    if not isFromQuest or ItemGlobals.isFromQuest(pantId):
        ...
        for beltId in belts:
            ...
            if not isFromLoot or ItemGlobals.isFromLoot(beltId):
                if not isFromShop or ItemGlobals.isFromShop(beltId):
                    if not isFromQuest or ItemGlobals.isFromQuest(beltId):
        ...
        for shoeId in shoes:
            ...
            if not isFromLoot or ItemGlobals.isFromLoot(shoeId):
                if not isFromShop or ItemGlobals.isFromShop(shoeId):
                    if not isFromQuest or ItemGlobals.isFromQuest(shoeId):
    ...
    def setClothesTexture(self, tex, listParts, layer, color = None):
        for i in xrange(0, len(listParts)):
    ...
    def setPartTexture(self, part, geomIdx, texIdx, pieces):
        ...
        if len(texName) == 1:
            ...
            tex = self.clothesTextures.findTexture(texName[0])
            self.setClothesTexture(tex, [
                pieces[0]], self.partLayer[part], lowLODColor)
            if len(pieces) > 2:
                self.setClothesTexture(tex, [
                    pieces[2]], self.partLayer[part], lowLODColor)

            tex = self.clothesTextures.findTexture(texName[1])
            self.setClothesTexture(tex, [
                pieces[1]], self.partLayer[part], lowLODColor)
    ...
    def handleClothesHiding(self):
        ...
        elif hasattr(self.pirate, 'crazyColorSkin') and self.pirate.crazyColorSkin == True:
    ...
    def handleClothesHidingOld(self):
        ...
        for j in xrange(0, len(layerPant[0])):
        ...
        for j in xrange(0, len(layerShoe[0])):
        ...
        if vestIdx[0] < 3:
            ...
            for j in xrange(0, len(layerShirt[0])):
        ...
        for j in xrange(0, len(layerVest[0])):
        ...
        for j in xrange(0, len(layerBelt[0])):
        ...
        for j in xrange(0, len(layerCoat[0])):
    ...
    def handleLayer2Hiding(self, clothingLayer, layer1Element, hide1 = 'base', hide2 = None, hide3 = None, hide4 = None):
        for i in xrange(0, len(layer1Element[0])):
            parts = clothingLayer[layer1Element[0][i]]
            for j in xrange(0, parts.getNumPaths()):
                if hide1 != None and parts[j].getName().find(hide1) != -1:
                    parts[j].stash()
                    self.notify.debug('hiding %s' % parts[j].getName())
                    continue
                if hide2 != None and parts[j].getName().find(hide2) != -1:
                    parts[j].stash()
                    self.notify.debug('hiding %s' % parts[j].getName())
                    continue
                if hide3 != None and parts[j].getName().find(hide3) != -1:
                    parts[j].stash()
                    self.notify.debug('hiding %s' % parts[j].getName())
                    continue
                if hide4 != None and parts[j].getName().find(hide4) != -1:
                    parts[j].stash()
                    self.notify.debug('hiding %s' % parts[j].getName())
                    continue
    ...
    def handleLayer3Hiding(self, clothingLayer, layer2Element, layer1Element, hideAll = False):
        for i in xrange(0, len(layer2Element[0])):
    ...
    def hideAllJewelry(self):
        ...
        self.jewelryREarIdx = [
            ...
            0,
            0]
        self.jewelryLBrowIdx = [
            0,
            0,
            0]
        self.jewelryRBrowIdx = [
            0,
            0,
            0]
        self.jewelryNoseIdx = [
            ...
            0,
            0]
        self.jewelryMouthIdx = [
            0,
            0,
            0]
        self.jewelryLHandIdx = [
            0,
            0,
            0]
        self.jewelryRHandIdx = [
            0,
            0,
            0]
        self.accFace.stash()
            ...
            for lod in [
                ...
                for idx in shirt[0]:
                    ...
                    for i in xrange(pieceSet.getNumPaths()):
                        ...
                        if not not front:
                            pass
                        coat = not (name.find('vcut') < 0)
                        if belt and name.find('base') < 0 and front:
                            pass
                        vest2 = name.find('waist') < 0
                        if vest2 and name.find('low_vcut') < 0:
                            pass
                        vest1 = name.find('breast') < 0
    ...
    def generateHairSets(self):
        ...
        for i in xrange(dreads.getNumPaths()):
